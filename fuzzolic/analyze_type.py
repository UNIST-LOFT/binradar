...
class Parser():
    ...
    def parse(self):
        ...
        self.parser.add_schema("[stack] [push] [sp: hex] [size: hex] [pc: hex] [dpeth: int] [sr-base: hex] [sr-size: hex]")
        ...
        self.parser.add_schema("[loadh] [reg: str] [pc: hex] [addr: hex] [reg-base: hex] [offset: hex] [size: hex] [r0: hex] [r1: hex] [r2: hex] [r3: hex] [r4: hex] [r5: hex] [r6: hex] [r7: hex] [r8: hex] [r9: hex] [r10: hex] [r11: hex] [r12: hex] [r13: hex] [r14: hex] [r15: hex]")
        self.parser.add_schema("[storeh] [reg: str] [pc: hex] [addr: hex] [reg-base: hex] [offset: hex] [size: hex] [r0: hex] [r1: hex] [r2: hex] [r3: hex] [r4: hex] [r5: hex] [r6: hex] [r7: hex] [r8: hex] [r9: hex] [r10: hex] [r11: hex] [r12: hex] [r13: hex] [r14: hex] [r15: hex]")
    ...
    def analyze(self):
        ...
        for stack_push in data["stack"]["push"]:
            print(f"Stack Push at PC {hex(stack_push['pc'])}: SP {hex(stack_push['sp'])}, Size {hex(stack_push['size'])}, Depth {stack_push['dpeth']}")
        ...
        for loadh in data["loadh"]:
            print(f"LoadH at PC {hex(loadh['pc'])}: Reg {loadh['reg']}, Addr {hex(loadh['addr'])}, Offset {hex(loadh['offset'])}, Size {hex(loadh['size'])}")
        for storeh in data["storeh"]:
            print(f"StoreH at PC {hex(storeh['pc'])}: Reg {storeh['reg']}, Addr {hex(storeh['addr'])}, Offset {hex(storeh['offset'])}, Size {hex(storeh['size'])}")
        return data